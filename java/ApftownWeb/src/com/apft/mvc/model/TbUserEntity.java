...
//	
	...
	private TbUserSubEntity tbUserSubEntity;
	
	private TbUserPersonalEntity tbUserPersonalEntity;
	
	private java.lang.String userComp;
	...
	public TbUserEntity(String userName, String userRegMobile,
			String userRegEmail, String userPwd) {
		super();
...
//	 * 方法: 取得java.lang.String
//	 * 
//	 * @return: java.lang.String userPwd2
//	 */
//	@Column(name = "USER_PWD2", nullable = true, length = 40)
//	public java.lang.String getUserPwd2() {
...
//	 * 方法: 设置java.lang.String
//	 * 
//	 * @param: java.lang.String userPwd2
//	 */
//	public void setUserPwd2(java.lang.String userPwd2) {
...
//	}
	...
	public TbUserPersonalEntity getTbUserPersonalEntity() {
		return tbUserPersonalEntity;
	}

	public void setTbUserPersonalEntity(TbUserPersonalEntity tbUserPersonalEntity) {
		this.tbUserPersonalEntity = tbUserPersonalEntity;
	}
	
	public int getSubType(){
		if (null != tbUserSubEntity)
			return tbUserSubEntity.getUserType();
		return 0;
	}

	public TbUserSubEntity getTbUserSubEntity() {
		return tbUserSubEntity;
	}

	public void setTbUserSubEntity(TbUserSubEntity tbUserSubEntity) {
		this.tbUserSubEntity = tbUserSubEntity;
	}
	

	@Override
	public String toString() {
		return "TbUserEntity [id=" + id + ", userName=" + userName + ", userRegMobile=" + userRegMobile + ", userRegEmail=" + userRegEmail + ", userPwd=" + userPwd + ", userMoney=" + userMoney
				+ ", creditClassid=" + creditClassid + ", creditStatus=" + creditStatus + ", userType=" + userType + ", userCat=" + userCat + ", userFrom=" + userFrom + ", userMultiName="
				+ userMultiName + ", userRealName=" + userRealName + ", userId=" + userId + ", userStatus=" + userStatus + ", userIntroduction=" + userIntroduction + ", insertTime=" + insertTime
				+ ", userLastSignin=" + userLastSignin + ", userImg=" + userImg + ",userDealer="+userDealer+"]";
	}

	public java.lang.String getUserComp() {
		return userComp;
	}

	public void setUserComp(java.lang.String userComp) {
