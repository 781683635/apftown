...
public class RequestHandler {
	 ...
	 */
	public static String createSign(String charSet,SortedMap<String,String> parameters,String keyValue){
		StringBuffer sb = new StringBuffer();
...
//		sb.append("key=" + "8934e7d15453e97507ef794cf7b0519d");
	...
	public static void main(String []argv){
		...
		packageParams.put("appid", "wxd930ea5d5a258f4f");
		packageParams.put("auth_code", "123456");
		packageParams.put("body", "test");
		packageParams.put("device_info", "123");
		packageParams.put("mch_id", "1900000109");
		packageParams.put("nonce_str", "960f228109051b9969f76c82bde183ac");
		packageParams.put("out_trade_no", "1400755861");
		packageParams.put("spbill_create_ip", "127.0.0.1");
		packageParams.put("total_fee", "1");
		//packageParams.put("key", "8934e7d15453e97507ef794cf7b0519d");
