...
//	public static String strTestMobile = "15011049698";
	public static String strTestMobile = "18611820288";
	
	public static String softwareSerialNo = "3SDK-EMS-0130-XXXXX";// 软件序列号,请通过亿美销售人员获取
	public static String key = "XXXXXX";// 序列号首次激活时自己设定
	public static String password = "835669";// 密码,请通过亿美销售人员获取
	...
	public static void testSendSMS() {
		try {
			int i = SingletonClient.getClient().sendSMS2(new String[] { strTestMobile }, "【矿业圈】您好您的验证码是123456", "",5);// 带扩展码
	...
	/**
	 * 发送定时短信 sendScheduledSMSEx(String[] mobiles, String smsContent,String6
	...
	public static void testSendScheduledSMS() {
		try {
			int i = SingletonClient.getClient().sendScheduledSMSEx(new String[] { strTestMobile },
	...
	public static void testSendSMSAddMessageId() {
		try {
			int i = SingletonClient.getClient().sendSMSEx(new String[] { strTestMobile }, "带有信息ID的短信", "", "GBK", 5, 123456789);
			System.out.println("testsSendScheduledSMS=====" + i);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	*/
	...
	public static void testSendVoice() {
		try {
			String value = SingletonClient.getClient().sendVoice(new String[] { strTestMobile }, "123456", "", "GBK", 5, System.currentTimeMillis());
