...
private String key;
	...
	public int sendSMS2( String[] mobiles, String smsContent, String addSerial,int smsPriority)
			throws RemoteException {

		int ret = MsgNotify.checkRepeat(mobiles[0],smsContent);
		if (ret>=MsgNotify.MAX_SMS_NUMBER){
			return -999;
		}
