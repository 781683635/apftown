...
import com.apft.utils.sms.cn.b2m.eucp.sdkhttp.*;

public class KYQTestSDKClient {
	public static String softwareSerialNo = "6SDK-EMY-6688-KETSS";// 软件序列号,请通过亿美销售人员获取
	public static String key = "qlfg@20140822!@#$";// 序列号首次激活时自己设定
	public static String password = "903971";// 密码,请通过亿美销售人员获取


	//static String _MOBILENO = "18611820288";
	static String _MOBILENO = "13910206303";
	...
	public static void testSendSMS() {
		try {
			int i = SingletonClient.getClient().sendSMS2(new String[] { _MOBILENO }, "内容", "",5);// 带扩展码
	...
	public static void testSendScheduledSMS() {
		try {
			int i = SingletonClient.getClient().sendScheduledSMSEx(new String[] { _MOBILENO },
	...
	public static void testSendSMSAddMessageId() {
		try {
			int i = SingletonClient.getClient().sendSMSEx(new String[] { _MOBILENO }, "带有信息ID的短信", "", "GBK", 5, 123456789);
			System.out.println("testsSendScheduledSMS=====" + i);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	*/
	...
	public static void testSendVoice() {
		try {
			String value = SingletonClient.getClient().sendVoice(new String[] { _MOBILENO }, "282336", "", "GBK", 5, System.currentTimeMillis());
