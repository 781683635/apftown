...
<div class="wrap">
	...
	<div class="pd-5">
		...
		<div class="clear mt-5">
				...
				<div class="col-xs-6 pt-5 pb-15 pl-5 pr-5 lists">
					...
					<div class="list-info">
						...
						<div class="clear pt-10">
							<time class="pull-left col-999">${list1.update_time}</time>
							<div class="pull-right">
								<span class="icon-heart-empty pull-left col-red-2 line-h-15"></span>
								<span class="pull-left pr-10"><fmt:formatDate value="${list1.update_time}" pattern="yyy-MM-dd"/> </span>
			...
			<form action="<%=path %>/s/index.do" id="pageForm" method="get">
