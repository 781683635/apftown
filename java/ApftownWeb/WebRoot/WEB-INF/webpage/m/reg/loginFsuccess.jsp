...
<html>
  <head>
    ...
    <title>登录成功-亚太金融(基金)小镇_基金注册_注册基金_基金小镇_金融小镇</title>
...
<body>
	...
	<!-- 顶部END -->
	<!-- 注册成功 -->
	<div class="clear full-w bg-white pt-20">
		<div class="col-3 col-offset-1 pull-left pd-0">
			<div class="clear weqh2 bg_edf1f1 radius-10 bor-ccc">
				<img class="pd-5" src="${pageContext.request.contextPath }/img/mobile/reg_f/succ_logo.png" alt="">
			</div>
		</div>
		<div class="col-8 pull-left">
			<p class="f-22 text-center col_22ac38 f-w pl-0 pr-0 pb-5 pt-15 ">
				欢迎
				<span class="col_22ac38">
					<%=user.getRegName() %>
				</span>
			</p>
			<div class="clear ml-20 mr-20 bor-22ac38"></div>
			<div class="clear pt-10 text-center">
				<img class="img-25 dis-ib pos-r pos-t-4l" src="${pageContext.request.contextPath }/img/mobile/reg_f/f_true.png" alt="亚太金融小镇logo">
	...
	<div class="clear full-w bor-b-white">
		<div class="col-4 pull-left bor-r-white pd-20">
			<div class="clear weqh bg_00b0ec bgh_red full-radius tab1">
		...
		<div class="col-4 pull-left bor-r-white pd-20">
			<div class="clear weqh bg_00a4b4 bgh_red full-radius tab2">
		...
		<div class="col-4 pull-left bor-r-white pd-20">
			<div class="clear weqh bg_aacd06 bgh_red full-radius tab3">
	...
	<div class="clear full-w">
		<div class="col-4 pull-left bor-r-white pd-20">
			<div class="clear weqh bg_f17c00 bgh_red full-radius tab4">
		...
		<div class="col-4 pull-left bor-r-white pd-20">
			<div class="clear weqh bg_e95098 bgh_red full-radius tab5">
		...
		<div class="col-4 pull-left pd-20">
			<div class="clear weqh bg_7d4698 bgh_red full-radius tab6">
