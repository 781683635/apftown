...
<html lang="en">
  ...
  <body>
			...
			<div class="clear full-w pt-20">
				...
				<div class="col-6 text-center pull-left">
					<div class="col-6 dis-ib pt-20">
						<button onclick="javascript:window.location.href='${pageContext.request.contextPath}/user/UintoPark.do'" class="btn btn-small btn-primary full-w f-14" type="button">
							取消
						</button>
					</div>
				</div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/user/Fbainfo.js"></script>
  </body>
