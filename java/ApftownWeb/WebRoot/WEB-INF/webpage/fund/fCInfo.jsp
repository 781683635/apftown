...
<html lang="en">
  <head>
    ...
    <title>填写入驻申请-亚太金融(基金)小镇_基金注册_注册基金_基金小镇_金融小镇</title>
  ...
  <body>
			...
			<% if(!s_oem.isMobile()){ %>
				<div class="clear">
					...
					<span class="pull-right pt-20">
						...
						<i class=" icon-angle-right pl-5 pr-5"></i>政策与服务
						<i class=" icon-angle-right pl-5 pr-5"></i>填写入驻申请
					</span>
				</div>
			 <%} %>
			...
			<!-- 入园申请头部 -->
				<div class="clear mb-20">
					<h3 class="clear gradient-gray line-h-40">
						<span class="f-20 mt-10 col-primary pl-10 f-w">填写入驻申请</span>
	                 	<span class="f-18 mb-10 col-ccc pl-10">In The Application</span>
					</h3>            
	            </div>
	        <!-- 入园申请头部END -->
		<div class="clear full-w">
			<p class="f-22 text-center mb-10">入驻基本信息</p>
			<p class="f-16 line-h-20">
				<span class="col-red">
					尊敬的用户您好：
				</span>
				欢迎入驻我们的园区，请您仔细填写下方的入驻申请基本信息。如需填写完整的入驻申请表，请下载
				<a class="col-primary hov-pri" href="http://www.apftown.com/upload/fund/亚太金融小镇入驻申请书.zip"download>
					完整入驻申请书
				</a>
				并发送到我们的邮箱：
				<a class="col-primary hov-pri" href="mailto:info@apftown.com">
					info@apftown.com
				</a>
				。如填写遇到困难，可致电
				<a class="col-primary hov-pri" href="tel:400-0881124">
					400-088-1124
				</a>
				，我们有专人为您解答。
			</p>
			...
			<div class="clear full-w pt-20">
				...
				<div class="col-6 text-center pull-left">
					<div class="col-6 dis-ib pt-20">
						<button onclick="javascript:window.location.href='${pageContext.request.contextPath}/user/fInto.do'" class="btn btn-small btn-primary full-w f-14" type="button">
							取消
						</button>
					</div>
				</div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/fund/fCInfo.js"></script>
  </body>
