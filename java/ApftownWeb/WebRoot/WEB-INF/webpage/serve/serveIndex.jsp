...
<html>
  <head>
    ...
    <title>服务中心-亚太金融(基金)小镇_基金注册_注册基金_基金小镇_金融小镇</title>
  	...
  	<div class="wrap serve">
				...
				<div class="container clear">
					<div class="col-sm-3 col-md-2 pl-0 pr-0 pt-20 mt-20 intro-text">
						<div class="overflow-h">
							...
							<div class="gra-pri2">
								<h3 class="col-black pd-10 f-w f-16">服务中心</h3>
								<div class="pb-5 gra-pri2 ml-10 mr-10"></div>
								<ul class="pt-10 pb-20 t-none f-14 subnav">	
									<c:forEach var="list1" items="${listMap1 }">
									<li class="mb-5">
										<span class="inline-block full-w pl-15 pt-5 pb-5 cur-p <c:if test='${propCode == list1.code }'>cur-list</c:if>" onclick="changeCode(${list1.code });" id="${list1.code }">
											<i class="icon-double-angle-right f-16 col-pri pr-5"></i>
											${list1.name } 
										</span>
					...
					<div class="col-sm-6 col-md-5 col-lg-4  banner-info">
							...
							<div class="text pd-10">
								...
								<p class="f-16 pt-10 clear"><span class="pull-left col-white2 pt-5">宣传视频</span><img class="play pull-left img-30 ml-20" src="<%=path %>/img/video.png" alt="亚太金融（基金）小镇"></p>
		...
		<div class="col-sm-10 product pr-0">
			...
			<div class="bg-white clear">
				...
				<form action="<%=path %>/s/index.do" id="pageForm">
